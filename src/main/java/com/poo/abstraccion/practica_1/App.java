...
public class App {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("\nDepósito realizado con éxito en cuenta 1.");

            cuenta2.depositar(300.0);
            System.out.println("Depósito realizado con éxito en cuenta 2.");
        ...
        System.out.println("Cuenta 2: " + cuenta2.consultarSaldo());

        // Realizar un retiro
        try {
            cuenta1.retirar(150.0);
            System.out.println("\nRetiro realizado con éxito en cuenta 1.");

            cuenta2.retirar(300.0);
            System.out.println("Retiro realizado con éxito en cuenta 2.");
        } catch (IllegalArgumentException e) {
        ...
        List<Transaccion> transacciones = cuenta1.consultarUltimasTransacciones();
        System.out.println("\nTransacciones de la cuenta 1:");
        for (Transaccion transaccion : transacciones) {
            System.out.println(transaccion.toString());
        }

        // Consultar transacciones de la cuenta 2
        List<Transaccion> transacciones2 = cuenta2.consultarUltimasTransacciones();
        System.out.println("\nTransacciones de la cuenta 2:");
